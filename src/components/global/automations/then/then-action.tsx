import { useListenter } from "@/hooks/use-automations";
...
interface ThenActionProps {
  id: string;
}

const ThenAction: React.FC<ThenActionProps> = ({ id }) => {
  const {
    onSetListener,
    listener: Listener,
    onFormSubmit,
          ...
          <Textarea
            placeholder={
              Listener === "SMARTAI"
                ...
                : "Add a message you want to sent to your customers"
            }
            {...register("prompt")}
